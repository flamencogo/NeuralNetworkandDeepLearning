...
mydata_train,mydata_train_y,mydata_test,mydata_test_y = pic_to_testdata.array_split(array_data_out,label_data_out,0.8)
...
net.SGD(training_data, mydata_train_data, 300, 4, 3.0, test_data=test_data)
